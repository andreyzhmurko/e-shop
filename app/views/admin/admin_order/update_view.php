<section>
    <div class="container">
        <div class="row">
            ...
            <h4>Редактировать заказ № <?= $this->id ?></h4>
            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post">
                        ...
                        <p>Имя клиента</p>
                        <input type="text" name="user_name" placeholder="" value="<?= $this->user_name; ?>">

                        <p>Телефон клиента</p>
                        <input type="text" name="user_phone" placeholder="" value="<?= $this->user_phone; ?>">

                        <p>Комментарий клиента</p>
                        <input type="text" name="user_comment" placeholder="" value="<?= $this->user_comment; ?>">

                        <p>Статус</p>
                        <select name="status">
                            <?php $order['status'] = $this->status; ?>
